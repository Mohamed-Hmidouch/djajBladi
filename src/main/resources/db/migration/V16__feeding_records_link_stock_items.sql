...
-- Ajout des feeding records pour LOT-2025-002 (batch_id=6, arrival_date=2026-02-27, 4500 poussins)
...
(6, '2026-02-27', 15.50, 'Demarrage', 2, 'J1 - Phase demarrage', 1, NOW(), NOW()),
(6, '2026-02-28', 16.20, 'Demarrage', 2, 'J2 - Phase demarrage', 1, NOW(), NOW()),
(6, '2026-03-01', 17.00, 'Demarrage', 2, 'J3 - Phase demarrage', 1, NOW(), NOW()),
(6, '2026-03-02', 17.80, 'Demarrage', 2, 'J4 - Phase demarrage', 1, NOW(), NOW()),
(6, '2026-03-03', 18.60, 'Demarrage', 2, 'J5 - Phase demarrage', 1, NOW(), NOW()),
(6, '2026-03-04', 19.40, 'Demarrage', 2, 'J6 - Phase demarrage', 1, NOW(), NOW()),
(6, '2026-03-05', 20.20, 'Demarrage', 2, 'J7 - Phase demarrage', 1, NOW(), NOW()),
(6, '2026-03-06', 21.00, 'Demarrage', 2, 'J8 - Phase demarrage', 1, NOW(), NOW()),
(6, '2026-03-07', 21.80, 'Demarrage', 2, 'J9 - Phase demarrage', 1, NOW(), NOW()),
(6, '2026-03-08', 22.60, 'Demarrage', 2, 'J10 - Phase demarrage', 1, NOW(), NOW()),
-- Phase croissance : J11 (2026-03-09)
(6, '2026-03-09', 24.00, 'Croissance', 3, 'J11 - Phase croissance', 1, NOW(), NOW());
